...
public class DeactivateCategoryHandler extends HandlerBase {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        Corn.log(Level.FINEST, "Deactivate Category Handler");
        try {
            ...
            ServerFacade.getInstance().deactivateCategory(new User(token), categoryID);
